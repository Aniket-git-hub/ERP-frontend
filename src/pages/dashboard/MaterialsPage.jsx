...
function MaterialsPage() {
    ...
    const tabs = [
        { title: "Add Materials", component: <AddMaterials />, searchParamName: 'addMaterial' },
        { title: "View Materials", component: <ViewMaterials />, searchParamName: 'view' },
    ];
    // console.log(searchParams.get('view'));
    return <TabsComponent tabs={tabs} defaultIndex={searchParams.get('view') && 1} />
}
