...
function ScrapPage() {
    ...
    return (
        <Box p={5}>
            <Heading mb={5} size={'lg'} color={'gray.700'}>Scrap Sell</Heading>
            <Flex w={"100%"} gap={10}>
                <Box flex={1} pt={5} pb={10} px={5} boxShadow={'0 2px 4px rgba(0, 0, 0, 0.2)'} borderRadius={'15px'}>
                    <Heading mb={5} size={'md'} color={'gray.700'}>Add Scrap Sell</Heading>
                    <form onSubmit={handleSubmit}>
                        ...
                        <FormControl isRequired mt={2} isInvalid={errors.buyer}>
                            ...
                            <InputGroup>
                                <Input type="text" name="buyer" value={values.buyer} onChange={handleChange()} />
                            </InputGroup>
                        ...
                        <FormControl isRequired mt={2} isInvalid={errors.weight}>
                            ...
                            <InputGroup>
                                <Input type="number" name="weight" value={values.weight} onChange={handleChange()} textAlign={"right"} />
                        ...
                        <FormControl isRequired mt={2} isInvalid={errors.amount}>
                            ...
                            <InputGroup>
                                <Input type="number" name="amount" value={values.amount} onChange={handleChange()} textAlign={"right"} />
                                <InputRightAddon children={"Rs"} />
                            </InputGroup>
                            <FormErrorMessage> {errors.amount}</FormErrorMessage>
                        </FormControl>
                        <FormControl mt={4}>
                            <Button type="submit" w={"100%"} colorScheme="purple" isLoading={isSubmitting} loadingText="Adding..." isDisabled={isSubmitting}>Add Scrap Sell </Button>
                        </FormControl>
                    </form>
                </Box>
                <Box flex={3}>
                    <Heading color={"gray.700"} size={"md"}>Scrap Sells</Heading>
                    <TableContainer>
                        <Table>
