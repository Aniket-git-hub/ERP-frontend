          ...
          <form onSubmit={handleSubmit}>
            <FormControl isRequired mt={2} isInvalid={errors.departmentId}>
              ...
              <Select
                ...
                options={department}
                values={
                  department.filter((e) => e.value === values.departmentId)[0]
                }
              />
        ...
        <Box flex={3}>
          ...
          <Box mx={3}>
            {designationByDepartment &&
              designationByDepartment.map((d, index) => (
                <Box key={`${d.department}-${index}`}>
                  ...
                  <Flex wrap={"wrap"} w={"100%"}>
                    {d.designations.length > 0 ? (
                      d.designations.map((designation, index) => (
                        <Box
                        ...
                        >
                          <Flex
                            ...
                            alignItems={"center"}
                          >
                            <Text mr={10}>{designation.name}</Text>
                            <ButtonGroup>
                              <CustomModal
                                trigger={(onOpen) => (
                                  <IconButton
