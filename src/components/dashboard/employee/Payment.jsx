import { Box, Button, Flex, FormControl, FormErrorMessage, FormLabel, HStack, Heading, Input, InputGroup, InputRightAddon, Table, TableCaption, TableContainer, Tbody, Td, Textarea, Th, Thead, Tr } from "@chakra-ui/react"
...
function Payment() {
    ...
    const initialState = { attendanceMonth: "", date: "", deductionAmount: "", remarks: "", employeeId: "", modeOfPayment: "" }
    ...
    return (
        <Box>
            <Flex w={"100%"} gap={10}>
                <Box flex={1} pt={5} pb={6} px={5} boxShadow={'0 2px 4px rgba(0, 0, 0, 0.2)'} borderRadius={'15px'}>
                    <Heading mb={5} size={'md'} color={'gray.700'}>Make Payment</Heading>
                    <form onSubmit={handleSubmit}>
                        <FormControl isRequired isInvalid={errors.employeeId}>
                            ...
                            <Select
                                ...
                                value={employeeOptions.filter(eO => eO.value === values.employeeId)[0]}
                            />
                        ...
                        <HStack>
                            <FormControl isRequired mt={2} isInvalid={errors.attendanceMonth}>
                                ...
                                <InputGroup>
                                    <Input type="month" name="attendanceMonth" value={values.attendanceMonth} onChange={handleChange()} />
                                </InputGroup>
                        ...
                        <HStack>s
                            <FormControl isRequired mt={2} isInvalid={errors.modeOfPayment}>
                                ...
                                <Select
                                    ...
                                    value={modesOfPayment.filter(eO => eO.value === values.modeOfPayment)[0]}
                                />
                            ...
                            <FormControl mt={2} isInvalid={errors.deductionAmount}>
                                ...
                                <InputGroup>
                                    <Input type="number" textAlign={"right"} name="deductionAmount" value={values.deductionAmount} onChange={handleChange()} />
                        ...
                        <FormControl isRequired mt={2} isInvalid={errors.remarks}>
                            ...
                            <InputGroup>
                                <Textarea name="remarks" value={values.remarks} onChange={handleChange()} />
                            </InputGroup>
                            <FormErrorMessage>{errors.remarks}</FormErrorMessage>
                        </FormControl>
                        <FormControl mt={4}>
                            <Button type="submit" w={"100%"} colorScheme="purple" isLoading={isSubmitting} loadingText="Creating..." isDisabled={isSubmitting}>Make Payment </Button>
                        </FormControl>
                    </form>
                </Box>
                <Box flex={3}>
                    <Heading color={"gray.700"} size={"md"}>Advances</Heading>
                    <TableContainer>
                        <Table>
