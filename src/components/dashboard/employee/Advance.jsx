        ...
        <Box>
            <Flex w={"100%"} gap={10}>
                <Box flex={1} pt={5} pb={10} px={5} boxShadow={'0 2px 4px rgba(0, 0, 0, 0.2)'} borderRadius={'15px'}>
                    <Heading mb={5} size={'md'} color={'gray.700'}>Create New Advance</Heading>
                    <form onSubmit={handleSubmit}>
                        ...
                        <FormControl mt={4}>
                            <Button type="submit" w={"100%"} colorScheme="purple" isLoading={isSubmitting} loadingText="Creating..." isDisabled={isSubmitting}>Create Advance </Button>
                        </FormControl>
                    </form>
                </Box>
                <Box flex={3}>
