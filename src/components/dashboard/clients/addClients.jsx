...
function AddClient() {
    ...
    return (
        <Container>
            <Box boxShadow={'0px 3px 15px rgba(0,0,0,0.2)'} py={5} px={8} rounded={"lg"}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <Center w={'100%'}>
                        <VStack w={'100%'}>
                            <Button w={'100%'} type="submit" my={2} colorScheme='purple' isLoading={isSubmitting} loadingText="Saving..." isDisabled={isSubmitting}>
                                Save Client
                            </Button>
                        </VStack>
                    </Center>
