            ...
            <form onSubmit={handleSubmit}>
                ...
                <HStack mt={2}>
                    <FormControl isInvalid={errors.date} isRequired>
                        ...
                        <Input type="month" name="date" value={values.date} onChange={handleChange()} />
                ...
                <Button my={5} w="full" type="submit" colorScheme="purple" loadingText="Adding Budget" isLoading={isSubmitting} isDisabled={isSubmitting}>Add Budget</Button>
            </form>
        </CustomModal>
    )
}
