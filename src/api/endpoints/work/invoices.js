...
export const getInvoiceById = async (id) =>
  handleRequest(`/invoice/${id}`, {}, "GET")
export const createInvoice = async (data) =>
  handleRequest("/invoice", data, "POST")
...
export const getAggregateInvoiceData = async (type, year, month) =>
  handleRequest(
    `/invoice/aggregate?type=${type}&month=${month}&year=${year}`,
    {},
    "GET",
  )
